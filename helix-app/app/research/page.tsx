      ...
      <div id="core-root" className={isDark ? 'hc-dark-theme' : ''}>
        ...
        <section className="hc-hero" style={{ minHeight: '60vh', paddingBottom: '2rem' }}>
          ...
          <div className="hc-hero-text-block reveal-on-scroll">
            <h1 className="hc-hero-headline serif-text">
              Research &<br /><u>Intelligence</u>
            </h1>
            <p className="hc-hero-subheadline serif-text">
              Zero-days, active campaigns, and advanced threat telemetry synthesized by Helix Core.
            </p>
          </div>
        </section>
        ...
        <section className="hc-feature" style={{ padding: '4rem 2rem', background: 'var(--hc-section-bg)', borderRadius: '40px', margin: '4rem auto', maxWidth: '1200px' }}>
          <div className="hc-feature-text reveal-on-scroll" style={{ maxWidth: '100%', textAlign: 'left' }}>
            <h2 className="hc-feature-title serif-text" style={{ fontSize: '2.5rem', marginBottom: '3rem' }}>Recent Publications</h2>
            
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              {/* Publication 1 */}
              <div style={{ padding: '2rem', border: '1px solid var(--hc-card-border)', borderRadius: '16px', background: 'var(--hc-card-bg)', transition: 'all 0.3s' }}>
                <span style={{ fontSize: '0.9rem', color: 'var(--hc-text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Threat Intel • Oct 14, 2026</span>
                <h3 style={{ fontSize: '1.5rem', fontWeight: 600, margin: '1rem 0', color: 'var(--hc-text-main)' }}>Bypassing Modern EDR: Stack Spoofing and Indirect Syscalls</h3>
                <p style={{ color: 'var(--hc-text-sub)', fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                  An in-depth analysis of how advanced persistent threats are leveraging dynamic call stacks to evade heuristic memory scanning in crowd-sourced EDR solutions.
                </p>
                <button className="hc-btn-solid" style={{ padding: '0.75rem 1.5rem', fontSize: '0.95rem' }}>Read Paper</button>
              </div>

              {/* Publication 2 */}
              <div style={{ padding: '2rem', border: '1px solid var(--hc-card-border)', borderRadius: '16px', background: 'var(--hc-card-bg)', transition: 'all 0.3s' }}>
                <span style={{ fontSize: '0.9rem', color: 'var(--hc-text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Vulnerability Research • Sep 28, 2026</span>
                <h3 style={{ fontSize: '1.5rem', fontWeight: 600, margin: '1rem 0', color: 'var(--hc-text-main)' }}>Active Campaign Analysis: APT-29 Kerberoasting Tactics</h3>
                <p style={{ color: 'var(--hc-text-sub)', fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                  Dissecting a new wave of highly targeted active directory attacks. We trace the lateral movement signatures synthesized by Helix Core across multiple enterprise environments.
                </p>
                <button className="hc-btn-solid" style={{ padding: '0.75rem 1.5rem', fontSize: '0.95rem' }}>Read Paper</button>
              </div>
              ...
              {/* Publication 3 */}
              <div style={{ padding: '2rem', border: '1px solid var(--hc-card-border)', borderRadius: '16px', background: 'var(--hc-card-bg)', transition: 'all 0.3s' }}>
                <span style={{ fontSize: '0.9rem', color: 'var(--hc-text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Reverse Engineering • Sep 10, 2026</span>
                <h3 style={{ fontSize: '1.5rem', fontWeight: 600, margin: '1rem 0', color: 'var(--hc-text-main)' }}>Deobfuscating Multi-Layered Ransomware Droppers</h3>
                <p style={{ color: 'var(--hc-text-sub)', fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                  A breakdown of the cryptographic primitives and anti-debugging tricks employed by a new zero-day ransomware dropper targeting cloud hypervisors.
                </p>
                <button className="hc-btn-solid" style={{ padding: '0.75rem 1.5rem', fontSize: '0.95rem' }}>Read Paper</button>
              </div>
            </div>
