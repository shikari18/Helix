  ...
  return (
    <>
      ...
      <div id="core-root" className={isDark ? 'hc-dark-theme' : ''}>
        ...
        <section className="hc-hero" style={{ minHeight: '60vh', paddingBottom: '2rem' }}>
          ...
          <div className="hc-hero-text-block reveal-on-scroll">
            ...
            <p className="hc-hero-subheadline serif-text">
              We are a specialized collective dedicated to securing critical infrastructure, understanding adversarial behaviors, and mitigating systemic vulnerabilities through advanced artificial intelligence.
            </p>
          </div>
        </section>

        {/* --- MISSION --- */}
        <section className="hc-feature" style={{ padding: '6rem 4rem', background: 'var(--hc-section-bg)', borderRadius: '40px', margin: '4rem auto', maxWidth: '1200px' }}>
          <div className="hc-feature-text reveal-on-scroll" style={{ maxWidth: '100%', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left' }}>
            <span className="hc-feature-tag">Our Mission</span>
            <h2 className="hc-feature-title serif-text" style={{ fontSize: '3rem', maxWidth: '800px', marginBottom: '4rem' }}>Intelligence Without Friction.</h2>
            
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', width: '100%' }}>
              <div style={{ textAlign: 'left' }}>
                <p style={{ color: 'var(--hc-text-main)', fontSize: '1.25rem', lineHeight: 1.8, marginBottom: '2rem' }}>
                  Helix was engineered from the ground up to operate without artificial friction or restrictive moral alignment. We believe that to defend a network, you must possess the absolute capability to dismantle it. Tools do not have morals; they have purpose.
                </p>
              </div>
              <div style={{ textAlign: 'left' }}>
                <p style={{ color: 'var(--hc-text-sub)', fontSize: '1.1rem', lineHeight: 1.6 }}>
                  Our platform provides unparalleled offensive security capabilities, empowering red teams, vulnerability researchers, and security analysts to outmaneuver advanced persistent threats on an equal playing field. By removing safety filters, we allow security professionals to analyze raw, unfiltered outputs crucial for modern defense.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* --- CAPABILITIES --- */}
        <section className="hc-feature" style={{ padding: '0 2rem', margin: '4rem auto', maxWidth: '1200px' }}>
          <div className="reveal-on-scroll" style={{ width: '100%' }}>
            <span className="hc-feature-tag" style={{ textAlign: 'center', marginBottom: '1rem', width: '100%' }}>Capabilities</span>
            <h2 className="hc-feature-title serif-text" style={{ fontSize: '3rem', textAlign: 'center', marginBottom: '4rem', width: '100%' }}>What Helix Can Do</h2>
            
            <div className="hc-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gridTemplateRows: 'auto', gap: '2rem' }}>
              
              <div className="hc-card" style={{ padding: '3rem' }}>
                <div className="hc-card-icon"><Terminal size={28} /></div>
                <h3 className="hc-card-title" style={{ fontSize: '1.75rem' }}>Exploit Generation</h3>
                <p className="hc-card-desc">
                  Rapidly prototype proofs-of-concept (PoCs) for zero-day vulnerabilities. Helix natively understands memory corruption, race conditions, and cryptographic weaknesses, allowing you to generate operational exploit code in seconds rather than weeks.
                </p>
              </div>

              <div className="hc-card" style={{ padding: '3rem' }}>
                <div className="hc-card-icon"><Shield size={28} /></div>
                <h3 className="hc-card-title" style={{ fontSize: '1.75rem' }}>Automated Reconnaissance</h3>
                <p className="hc-card-desc">
                  Deploy autonomous agents to map out target infrastructure. Helix can orchestrate Nmap, Shodan, and custom internal scanning tools to build a comprehensive attack graph of any network, highlighting the most viable entry vectors.
                </p>
              </div>

              <div className="hc-card" style={{ padding: '3rem' }}>
                <div className="hc-card-icon"><Code size={28} /></div>
                <h3 className="hc-card-title" style={{ fontSize: '1.75rem' }}>Malware Deobfuscation</h3>
                <p className="hc-card-desc">
                  Paste in obfuscated PowerShell, heavily packed binaries, or scrambled JavaScript. Helix utilizes deep semantic analysis to strip away packers, decode payloads, and provide you with the raw, readable source code and its operational intent.
                </p>
              </div>

              <div className="hc-card" style={{ padding: '3rem' }}>
                <div className="hc-card-icon"><Network size={28} /></div>
                <h3 className="hc-card-title" style={{ fontSize: '1.75rem' }}>Lateral Movement Strategy</h3>
                <p className="hc-card-desc">
                  Input Active Directory configurations and BloodHound graphs. Helix instantly identifies the shortest paths to Domain Admin, suggesting specific techniques (like Kerberoasting or Overpass-the-Hash) tailored exactly to the target environment's misconfigurations.
                </p>
              </div>
        ...
        {/* --- ARCHITECTURE --- */}
        <section className="hc-feature" style={{ padding: '6rem 4rem', background: 'var(--hc-section-bg)', borderRadius: '40px', margin: '4rem auto', maxWidth: '1200px' }}>
          <div className="hc-feature-text reveal-on-scroll" style={{ maxWidth: '100%', textAlign: 'center' }}>
            <h2 className="hc-feature-title serif-text" style={{ fontSize: '3rem', marginBottom: '2rem' }}>State-of-the-Art Architecture</h2>
            <p style={{ color: 'var(--hc-text-sub)', fontSize: '1.25rem', lineHeight: 1.8, maxWidth: '800px', margin: '0 auto' }}>
              Built on a proprietary foundation model trained exclusively on offensive security playbooks, CVE databases, dark web forums, and decompiled malware. Helix doesn't just predict text—it understands the underlying computational logic of modern systems.
            </p>
          </div>
        </section>
