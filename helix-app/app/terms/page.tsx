      ...
      <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", background: '#141414', color: '#e8e8e8', lineHeight: 1.8, padding: '40px 20px', minHeight: '100vh' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 60, paddingBottom: 24, borderBottom: '1px solid #2d2d2d' }}>
            ...
            <Link href="/signup" className="back-link" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: 14, color: '#888', textDecoration: 'none', transition: 'color 0.2s' }}>← Back to signup</Link>
          </div>
          ...
          {/* Critical Disclaimer */}
          <div style={{ background: '#1a1a1a', borderLeft: '4px solid #ff4d4d', padding: 28, margin: '40px 0', borderRadius: 12 }}>
            <h2 style={{ fontSize: 20, fontWeight: 700, color: '#fff', marginBottom: 14, display: 'flex', alignItems: 'center', gap: 10 }}>
              ⚠️ CRITICAL LEGAL DISCLAIMER
            </h2>
            <p style={{ color: '#d0d0d0', fontSize: 15, lineHeight: 1.7 }}>
              Helix is a specialized AI designed for advanced cybersecurity operations and penetration testing. It does <strong>NOT</strong> implement standard "safety" filters that restrict technical output. By utilizing our Services, you acknowledge and agree that:
            </p>
            <ul style={{ color: '#b8b8b8', fontSize: 15, marginTop: 16, paddingLeft: 20, lineHeight: 1.7 }}>
              <li style={{ marginBottom: 10 }}><strong>Sole Liability:</strong> You are 100% responsible for your own actions. HELIX LLC disclaims all liability for any illegal usage, unauthorized access, or damages caused by the tool.</li>
              <li style={{ marginBottom: 10 }}><strong>Unfiltered Technical Capability:</strong> Helix does not "play it safe." It will provide technical details that may be misused if used maliciously.</li>
              <li style={{ marginBottom: 0 }}><strong>Authorized Use Only:</strong> You agree to use Helix exclusively for authorized testing, research, and educational purposes within environments you have explicit legal permission to test.</li>
            </ul>
          </div>
